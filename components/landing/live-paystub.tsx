        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-10">
          ...
          <div>
            ...
            <div className="relative overflow-hidden rounded-[28px] bg-background shadow-glass">
              ...
              {/* On a phone this is the section's call to action, not a
                  footer control: 52px tall with real type, and centred with
                  margin rather than stretched edge to edge — a full-bleed
                  squat button is what read as cheap. The provenance line
                  moves below it, where a caption belongs. */}
              <div className="flex flex-col-reverse gap-3 border-t border-border/60 bg-muted/40 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-4">
                ...
                <Button
                  className="group mx-auto h-[52px] w-full max-w-[300px] rounded-full text-[15px] font-semibold shadow-soft sm:mx-0 sm:h-9 sm:w-auto sm:max-w-none sm:text-[13px] sm:font-medium sm:shadow-none"
